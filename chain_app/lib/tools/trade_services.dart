...
class TradeService {
  ...
  static Future<Response>sellOrder(String serialNo) async {
    ...
    return NServices.request(_sell_order, queryParameters: parameter, method: NServices.method_post);
  }
  ...
  static Future<Response>sellConfirm(String serialNo) async {
    ...
    return NServices.request(_sell_confirm, queryParameters: parameter, method: NServices.method_put);
  }
  ...
  static Future<Response> buyOrder(String serialNo) async {
    ...
    return NServices.request(_buy_order, queryParameters: parameter, method: NServices.method_post);
  }
  ...
  static Future<Response> buyFill(String serialNo, String ali) async {
    ...
    return NServices.request(_buy_fill, queryParameters: parameter, method: NServices.method_post);
  }
  ...
  static Future<Response>buyOrderConfirm(String serialNo) async {
    ...
    return NServices.request(_buy_order_confirm, queryParameters: parameter, method: NServices.method_put);
  }
}